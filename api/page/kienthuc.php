...
<div class="row px-md-5 px-3 pb-5 bg_light_grey news">
  ...
  <div class="d-flex flex-wrap">
    <div class="col-xxl-8 col-md-8 col-12 pb-5 pe-md-5 pe-0">
      <div class="row">
        <div class="col-12">
          <h3 class="pb-3">Kiến thức</h3>
        </div>
        <div class="col-6 mb-4">
          <div class="article-item bg-white">
            <a class="bg-img-cover d-block" href="index.php?p=chitietkienthuc" style="background-image: url(public/demo/khai_truong.webp);">
            </a>
            <div class="p-3">
              <h5 class="post-title">
                <a href="index.php?p=chitietkienthuc" title="Khai trương Cung Trầm Gallery - Nhìn lại cột mốc ngày 24/10/2022">Bột trầm hương là
                  gì? Công dụng và cách bảo quản bột trầm hương
                </a>
              </h5>
        ...
        <div class="col-6 mb-4">
          <div class="article-item bg-white">
            ...
            <div class="p-3">
              <h5 class="post-title">
                <a href="index.php?p=chitietkienthuc" title="Khai trương Cung Trầm Gallery - Nhìn lại cột mốc ngày 24/10/2022">Khai trương Cung
                  Trầm
                ...
                <div class="col-9">
                  <div class="post-content">
                    <h6 class="fw-normal mb-1">
                      <a href="index.php?p=chitietkienthuc">Bột trầm hương là gì? Công dụng và cách
